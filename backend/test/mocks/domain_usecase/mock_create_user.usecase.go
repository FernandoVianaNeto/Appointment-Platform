...
//
//	mockgen -source create_user.usecase.go -package domain_usecase -destination /home/fernandoviana/Documentos/Appointment-Platform/backend/test/mocks/domain_usecase/mock_create_user.usecase.go
//
...
func (m *MockCreateUserUsecaseInterface) Execute(ctx context.Context, input dto.CreateUserInputDto) error {
	m.ctrl.T.Helper()
